...
public class FraudDetectionJob {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<String> fileSource = env.readTextFile(filePath).name("localfile-source").setParallelism(1);

        // map 原始数据切分转换为实体类
        SingleOutputStreamOperator<PayLog> payLogDS = fileSource
                .map(new MapFunction<String, PayLog>() {
